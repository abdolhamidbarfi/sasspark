...
const stylesComponets = {
    h2: "lg:text-6xl max-lg:text-4xl max-md:text-4xl max-sm:text-3xl transition-all duration-200 lg:!leading-[5rem] md:!leading-[3rem] max-md:!leading-[2.5rem] font-bold mb-5",
